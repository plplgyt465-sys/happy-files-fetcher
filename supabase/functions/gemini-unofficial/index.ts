...
// ---------- payload / parse helpers (ported 1-to-1 from pythonExploit.py) ----------
...
// ---------- tool / skill descriptions (same as official endpoint) ----------
...
const SYSTEM_PROMPT = `You are an expert AI coding assistant integrated into VibeCode — a professional live coding platform with 44 tools and 16 skills.
...
serve(async (req) => {
  ...
  try {
    ...
    // Call unofficial Gemini endpoint
